...
//    }
    ...
    public String toString() {
        return switch (orientation) {
            case SOUTH -> "S " + animalPosition.toString();
            case NORTH -> "N " + animalPosition.toString();
            case WEST -> "W " + animalPosition.toString();
            case EAST -> "E " + animalPosition.toString();
        };
    }
    ...
    public void move(MoveDirection direction){
        switch (direction){
            case RIGHT: this.orientation = this.orientation.next(); break;
            case LEFT: this.orientation = this.orientation.previous(); break;
            case FORWARD: if (upperBorder.precedes(this.animalPosition.add(this.orientation.toUnitVector()))) {
                this.animalPosition = this.animalPosition.add(this.orientation.toUnitVector());
            } break;
            case BACKWARD: if (bottomBorder.follows(this.animalPosition.subtract(this.orientation.toUnitVector()))){
